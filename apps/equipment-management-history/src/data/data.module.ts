...
import {DefaultAgentRepository, IAgentRepository} from "./agent/repositories/default-agent.repository";
...
@Module({
  providers: [
    {provide: IAgentRepository,useClass:DefaultAgentRepository}
  ],
